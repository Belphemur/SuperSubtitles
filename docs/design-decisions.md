...
| [HTTP Client](./design-decisions/http-client.md) | HTTP resilience with failsafe-go (retry + circuit breaker); partial failure; client architecture; parallel pagination |
