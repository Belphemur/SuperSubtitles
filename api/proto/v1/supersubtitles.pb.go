...
type ThirdPartyIds struct {
	...
	TvdbId        uint64                 `protobuf:"varint,2,opt,name=tvdb_id,json=tvdbId,proto3" json:"tvdb_id,omitempty"`         // TVDB identifier
	TvMazeId      uint64                 `protobuf:"varint,3,opt,name=tv_maze_id,json=tvMazeId,proto3" json:"tv_maze_id,omitempty"` // TVMaze identifier
	TraktId       uint64                 `protobuf:"varint,4,opt,name=trakt_id,json=traktId,proto3" json:"trakt_id,omitempty"`      // Trakt identifier
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ThirdPartyIds) GetTvdbId() uint64 {
	if x != nil {
		return x.TvdbId
	}
	return 0
...
func (x *ThirdPartyIds) GetTvMazeId() uint64 {
	if x != nil {
		return x.TvMazeId
	}
	return 0
...
func (x *ThirdPartyIds) GetTraktId() uint64 {
	if x != nil {
		return x.TraktId
	}
	return 0
...
type Subtitle struct {
	...
	Episode       uint32                 `protobuf:"varint,7,opt,name=episode,proto3" json:"episode,omitempty"`
...
func (x *Subtitle) GetShowId() uint64 {
	if x != nil {
		return x.ShowId
	}
	return 0
...
func (x *Subtitle) GetSeason() uint32 {
	if x != nil {
		return x.Season
	}
	return 0
...
func (x *Subtitle) GetEpisode() uint32 {
	if x != nil {
		return x.Episode
	}
	return 0
...
func (x *SubtitleCollection) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *GetSubtitlesRequest) GetShowId() uint64 {
	if x != nil {
		return x.ShowId
	}
	return 0
...
type CheckForUpdatesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FilmCount     uint64                 `protobuf:"varint,1,opt,name=film_count,json=filmCount,proto3" json:"film_count,omitempty"`
...
func (x *CheckForUpdatesResponse) GetFilmCount() uint64 {
	if x != nil {
		return x.FilmCount
	}
	return 0
...
func (x *CheckForUpdatesResponse) GetSeriesCount() uint64 {
	if x != nil {
...
type DownloadSubtitleRequest struct {
	...
	Episode       uint32                 `protobuf:"varint,3,opt,name=episode,proto3" json:"episode,omitempty"` // Episode number to extract from season pack (0 = download entire file)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DownloadSubtitleRequest) GetEpisode() uint32 {
	if x != nil {
		return x.Episode
	}
	return 0
...
func (x *GetRecentSubtitlesRequest) GetSinceId() uint64 {
	if x != nil {
		return x.SinceId
	}
	return 0
...
const file_supersubtitles_proto_rawDesc = "" +
	...
	"\x04year\x18\x03 \x01(\rR\x04year\x12\x1b\n" +
	"\timage_url\x18\x04 \x01(\tR\bimageUrl\"z\n" +
	"\rThirdPartyIds\x12\x17\n" +
	"\aimdb_id\x18\x01 \x01(\tR\x06imdbId\x12\x17\n" +
	"\atvdb_id\x18\x02 \x01(\x04R\x06tvdbId\x12\x1c\n" +
	"\n" +
	"tv_maze_id\x18\x03 \x01(\x04R\btvMazeId\x12\x19\n" +
	"\btrakt_id\x18\x04 \x01(\x04R\atraktId\"\xeb\x03\n" +
	"\bSubtitle\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x17\n" +
	"\ashow_id\x18\x02 \x01(\x04R\x06showId\x12\x1b\n" +
	"\tshow_name\x18\x03 \x01(\tR\bshowName\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12\x1a\n" +
	"\blanguage\x18\x05 \x01(\tR\blanguage\x12\x16\n" +
	"\x06season\x18\x06 \x01(\rR\x06season\x12\x18\n" +
	"\aepisode\x18\a \x01(\rR\aepisode\x12\x1a\n" +
	...
	"\x05total\x18\x03 \x01(\x04R\x05total\"\xde\x01\n" +
	"\rShowSubtitles\x12+\n" +
	...
	"\ashow_id\x18\x01 \x01(\x04R\x06showId\"n\n" +
	...
	"\n" +
	"film_count\x18\x01 \x01(\x04R\tfilmCount\x12!\n" +
	"\fseries_count\x18\x02 \x01(\x04R\vseriesCount\x12\x1f\n" +
	...
	"subtitleId\x12\x18\n" +
	"\aepisode\x18\x03 \x01(\rR\aepisode\"s\n" +
	...
	"\bsince_id\x18\x01 \x01(\x04R\asinceId\"e\n" +
